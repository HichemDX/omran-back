...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <meta property="og:title" content="Omran"/>
    <meta property="og:type" content="Construction"/>
    <meta property="og:url" content="https://omran-dz.com/"/>
    <meta property="og:image" content="{{asset('assets/cover.png')}}"/>
    <meta property="og:site_name" content="Omran"/>
    <meta property="og:description"
          content="Meilleure application pour votre Achat de matériaux de construction."/>
  ...
  <body>
    ...
    <main class="main" id="top">
      {{-- <nav class="navbar navbar-expand-lg py-3" >
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" style="background-color: transparent" href="#">
            <div class="text-warning">
                <img class="img-fluid" src="{{asset('assets/logo.png')}}" width="70" alt="" />
            </div>
          </a>
        </div>
      </nav> --}}
      <section class="py-0" id="home">
        <div class="bg-holder" style="background-image:url({{asset('assets/assets/img/illustrations/hero-bg.png')}});background-position:bottom;background-size:cover;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container position-relative">
            <div class="row py-2">
                <div class="col-12 text-center">
                    <img class="img-fluid" src="{{asset('assets/logo2.png')}}" width="190" alt="" />
                </div>
            </div>
          <div class="row align-items-center py-5">
            <div class="col-md-5 col-lg-6 order-md-1 text-center text-md-end">
                <img class="img-fluid" src="{{asset('assets/phone.png')}}" width="235" alt="" />
            </div>
            <div class="col-md-7 col-lg-6 text-center text-md-start">
                    {{-- <span class="badge bg-light rounded-pill text-dark align-items-center d-flex flex-row-reverse justify-content-end mx-auto mx-md-0 ps-0 w-75 w-sm-50 w-md-75 w-xl-50 mb-3">
                        #1 Application Specialisé En Construction
                        <img class="img-fluid float-start me-3" src="{{asset('assets/assets/img/illustrations/arrow-right.png')}}" alt=""/>
                    </span> --}}
                <h1 class="mb-4 display-3 fw-bold lh-sm">
                    Meilleure application pour votre
                    <br class="d-block d-lg-none d-xl-block" />
                    Achat de matériaux de construction
                </h1>
                <p class="mt-3 mb-4 fs-1">
                    Achetez vos besoins depuis le lieu de travail
                    <br class="d-none d-lg-block" /><b>Facilement</b> et <b>Rapidement</b>.
                </p>
                {{-- <a class="btn btn-lg btn-primary rounded-pill hover-top" href="#" role="button">essayer gratuitement</a> --}}
                <div class="d-flex justify-content-center d-md-inline-block">
                    <a class="pe-2 pe-sm-3 pe-md-4" target="_blank" href="https://play.google.com/store/apps/details?id=com.omran.dz.khotwa">
                        <img src="{{asset('assets/assets/img/illustrations/google-play.png')}}" width="160" alt="" />
                    </a>
                </div>
      ...
      {{-- <section class="py-6">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-7 order-md-1 text-center text-md-start z-index-2 cta-image"><img class="img-fluid mb-4 mb-md-0" src="{{asset('assets/assets/img/illustrations/cta.png')}}" width="850" alt="" /></div>
